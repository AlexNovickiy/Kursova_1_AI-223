...
$postsAdm = selectAllPostsWithAuthors();
            ...
            <?php if (!empty($postsAdm)): ?>
                <?php foreach ($postsAdm as $key => $post): ?>
                    <div class="row post">
                        ...
                        <div class="title col-5"><?= isset($post['title']) ? mb_substr($post['title'], 0, 50, 'UTF-8'). '...' : 'Без назви'; ?></div>
                        <div class="author col-2"><?= isset($post['username']) ? $post['username'] : 'Невідомий користувач'; ?></div>
