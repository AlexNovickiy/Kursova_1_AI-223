...
<?php include "../../app/include/sidebar-admin.php"; ?>
        ...
        <div class="posts col-9">
            ...
            <?php if (!empty($commentsForAdm)): ?>
                <?php foreach ($commentsForAdm as $key => $comment): ?>
                    <div class="row post">
                        <div class="id col-1"><?= htmlspecialchars($comment['id']); ?></div>
                        <div class="title col-5"><?= mb_substr(htmlspecialchars($comment['comment'], ENT_QUOTES, 'UTF-8'), 0, 50, 'UTF-8') . '...'; ?></div>
                        <div class="author col-3"><?= htmlspecialchars(explode('@', $comment['email'])[0]) . '@'; ?></div>
