...
$text1 = isset($comment['text']) ? $comment['text'] : '';
$pub = isset($comment['publish']) ? $comment['publish'] : 0;
?>
<!doctype html>
<html lang="ru">
<head>
    ...
    <div class="posts col-9">
        ...
        <div class="row add-post">
            ...
            <form action="edit.php" method="post">
                ...
                <div class="col mb-4">
                    <input value="<?= htmlspecialchars($email); ?>" name="title" type="text" disabled class="form-control" placeholder="Title" aria-label="Назва статті">
                </div>
                <div class="col">
