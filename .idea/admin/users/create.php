...
// Ініціалізація змінних для форми
$login = '';
$email = '';
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $login = isset($_POST['login']) ? $_POST['login'] : '';  // Якщо значення є в $_POST, використовуємо його
    $email = isset($_POST['mail']) ? $_POST['mail'] : '';   // Якщо значення є в $_POST, використовуємо його
}
?>
<!doctype html>
<html lang="en">
            ...
            <div class="row add-post">
                ...
                <form action="create.php" method="post">
                    <div class="col">
                        ...
                        <input name="login" value="<?= htmlspecialchars($login) ?>" type="text" class="form-control" id="formGroupExampleInput" placeholder="введіть ваш логін...">
                    </div>
                    <div class="col">
