...
$title = '';  // Ініціалізація пустою строкою
$content = ''; // Ініціалізація пустою строкою
        ...
        <div class="posts col-9">
            ...
            <div class="row add-post">
                ...
                <form action="create.php" method="post" enctype="multipart/form-data">
                    <div class="col mb-4">
                        <input value="<?= htmlspecialchars($title, ENT_QUOTES); ?>" name="title" type="text" class="form-control" placeholder="Title" aria-label="Назва статті">
                    </div>
                    <div class="col">
                        <label for="editor" class="form-label">Вміст запису</label>
                        <textarea name="content" id="editor" class="form-control" rows="6"><?= htmlspecialchars($content, ENT_QUOTES); ?></textarea>
                    </div>
                    ...
                    <select name="topic" class="form-select mb-2" aria-label="Default select example">
                        ...
                        <?php if (!empty($topics)): ?>
                            <?php foreach ($topics as $topic): ?>
                                <option value="<?= htmlspecialchars($topic['id']); ?>">
