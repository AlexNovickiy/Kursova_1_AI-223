...
<div class="container reg_form">
    <form class="row justify-content-center" method="post" action="log.php">
        ...
        <div class="mb-3 col-12 col-md-4">
            ...
            <label for="exampleInputEmail1"></label><input name="mail" value="<?=$email?>" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="введіть ваш email...">
        </div>
        <div class="w-100"></div>
        <div class="mb-3 col-12 col-md-4">
