...
<div class="container reg_form">
    <form action="reg.php" method="post" class="row justify-content-center">
        ...
        <div class="mb-3 col-12 col-md-4">
            ...
            <div id="emailHelp" class="form-text">Ваша email адреса не буде використана для спаму!</div>
        </div>
        <div class="w-100"></div>
        <div class="mb-3 col-12 col-md-4">
        ...
        <div class="mb-3 col-12 col-md-4">
            ...
            <input name="pass-second" type="password" class="form-control" id="exampleInputPassword2" placeholder="повторіть пароль...">
        </div>
        <div class="w-100"></div>
        <div class="mb-3 col-12 col-md-4">
